...
class FlashCardViewModel extends StateNotifier<AsyncValue<List<FlashCardResponse>>> {
  final LearnVocabularyRepository _learnVocabularyRepository;

  FlashCardViewModel({required LearnVocabularyRepository learnVocabularyRepository})
